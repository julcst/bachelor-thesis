...
With this hardware-optimized implementation, \textcite{muller2021} achieve a speedup of $5\times$ to $10\times$ compared to the widely used TensorFlow framework \bcite{tensorflowdevelopers2021} on large batch sizes corresponding to HD resolution.
...
High spread paths on the other hand result in high Monte Carlo noise.

\paragraph{Balanced Termination Heuristic (BTH)} % TODO
